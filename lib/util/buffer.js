...
var node_scrypt = require('./scrypt.js');
var js = require('./js');
...
var scrypt = module.exports.scrypt = function(data) {
  // scrypt(passwd, salt, N, r, p, dkLen)
  /*console.log("-------------")
  console.log("data",data)
  console.log("-------------")*/
  //return node_scrypt(data, data, 1024, 1, 1, 32);
  /*var passwd = stringToHex("pleaseletmein")
  var salt = stringToHex("SodiumChloride")*/
  var N = 1024
  var r = 1
  var p = 1
  var dkLen = 32
  return node_scrypt(new Buffer(data), new Buffer(data), N, r, p, dkLen)
};
...
//module.exports.scrypt = node_scrypt
